...
| [conform.nvim](https://github.com/stevearc/conform.nvim) | Manual formatting; format-on-save off by default (Python `ruff`, C/C++ `clang-format`, Markdown `prettier`; container-routed when a `.nvim-docker.lua` marker is active) |
